...
static const GLfloat vertex_normals[] = {
    ...
    -0.5f, -0.5f, -0.5f,  0.0f,  0.0f, -1.0f,  1.0, 0.0, 0.0,
     0.5f, -0.5f, -0.5f,  0.0f,  0.0f, -1.0f,  1.0, 0.0, 0.0,
     0.5f,  0.5f, -0.5f,  0.0f,  0.0f, -1.0f,  1.0, 0.0, 0.0,
     0.5f,  0.5f, -0.5f,  0.0f,  0.0f, -1.0f,  1.0, 0.0, 0.0, // Back
    -0.5f,  0.5f, -0.5f,  0.0f,  0.0f, -1.0f,  1.0, 0.0, 0.0,
    -0.5f, -0.5f, -0.5f,  0.0f,  0.0f, -1.0f,  1.0, 0.0, 0.0,

    -0.5f, -0.5f,  0.5f,  0.0f,  0.0f,  1.0f,  1.0, 1.0, 1.0,
     0.5f, -0.5f,  0.5f,  0.0f,  0.0f,  1.0f,  1.0, 1.0, 1.0, //Front
     0.5f,  0.5f,  0.5f,  0.0f,  0.0f,  1.0f,  1.0, 1.0, 1.0,
     0.5f,  0.5f,  0.5f,  0.0f,  0.0f,  1.0f,  1.0, 1.0, 1.0,
    -0.5f,  0.5f,  0.5f,  0.0f,  0.0f,  1.0f,  1.0, 1.0, 1.0,
    -0.5f, -0.5f,  0.5f,  0.0f,  0.0f,  1.0f,  1.0, 1.0, 1.0,

    -0.5f,  0.5f,  0.5f, -1.0f,  -1.0f,  0.0f,  1.0, 1.0, 1.0,
    -0.5f,  0.5f, -0.5f, -1.0f,  -1.0f,  0.0f,  1.0, 1.0, 1.0,
    -0.5f, -0.5f, -0.5f, -1.0f,  -1.0f,  0.0f,  1.0, 0.0, 1.0,
    -0.5f, -0.5f, -0.5f, -1.0f,  -1.0f,  0.0f,  1.0, 0.0, 1.0,
    -0.5f, -0.5f,  0.5f, -1.0f,  -1.0f,  0.0f,  1.0, 0.0, 1.0,  // LEFT
    -0.5f,  0.5f,  0.5f, -1.0f,  -1.0f,  0.0f,  1.0, 1.0, 1.0,

     0.5f,  0.5f,  0.5f,  1.0f,  0.0f,  0.0f,  1.0, 1.0, 0.0,
     0.5f,  0.5f, -0.5f,  1.0f,  0.0f,  0.0f,  1.0, 1.0, 0.0,
     0.5f, -0.5f, -0.5f,  1.0f,  0.0f,  0.0f,  1.0, 0.0, 0.0,   // Right
     0.5f, -0.5f, -0.5f,  1.0f,  0.0f,  0.0f,  1.0, 0.0, 0.0,
     0.5f, -0.5f,  0.5f,  1.0f,  0.0f,  0.0f,  1.0, 0.0, 0.0,
     0.5f,  0.5f,  0.5f,  1.0f,  0.0f,  0.0f,  1.0, 1.0, 0.0,

    -0.5f, -0.5f, -0.5f,  0.0f, -1.0f,  0.0f,  1.0, 0.0, 0.0,
     0.5f, -0.5f, -0.5f,  0.0f, -1.0f,  0.0f,  1.0, 0.0, 0.0,    //Bottom
     0.5f, -0.5f,  0.5f,  0.0f, -1.0f,  0.0f,  1.0, 0.0, 0.0,
     0.5f, -0.5f,  0.5f,  0.0f, -1.0f,  0.0f,  1.0, 0.0, 0.0,
    -0.5f, -0.5f,  0.5f,  0.0f, -1.0f,  0.0f,  1.0, 0.0, 0.0,
    -0.5f, -0.5f, -0.5f,  0.0f, -1.0f,  0.0f,  1.0, 0.0, 0.0,

    -0.5f,  0.5f, -0.5f,  0.0f,  1.0f,  0.0f,  1.0, 1.0, 1.0,
     0.5f,  0.5f, -0.5f,  0.0f,  1.0f,  0.0f,  1.0, 1.0, 1.0,   //TOP
     0.5f,  0.5f,  0.5f,  0.0f,  1.0f,  0.0f,  1.0, 1.0, 1.0,
     0.5f,  0.5f,  0.5f,  0.0f,  1.0f,  0.0f,  1.0, 1.0, 1.0,
    -0.5f,  0.5f,  0.5f,  0.0f,  1.0f,  0.0f,  1.0, 1.0, 1.0,
    -0.5f,  0.5f, -0.5f,  0.0f,  1.0f,  0.0f,  1.0, 1.0, 1.0
...
CColorCube::CColorCube()  :BaseObject() {
...
void CColorCube::Draw( Camera * cam, GLuint shaderprog) {
